...
start_menu(){
    clear
	echo "
 ________  ___  _________  _______   ________        ___     
|\   ____\|\  \|\___   ___\\  ___ \ |\   __  \      |\  \    
\ \  \___|\ \  \|___ \  \_\ \   __/|\ \  \|\  \     \ \  \   
 \ \_____  \ \  \   \ \  \ \ \  \_|/_\ \  \\\  \  __ \ \  \  
  \|____|\  \ \  \   \ \  \ \ \  \_|\ \ \  \\\  \|\  \\_\  \ 
    ____\_\  \ \__\   \ \__\ \ \_______\ \_______\ \________\
   |\_________\|__|    \|__|  \|_______|\|_______|\|________|
   \|_________|                                                                                                         
    "
    greenbg "==============================================================="
    greenbg "简介：SITEOJ工具箱Docker版（一键部署23+优质程序）                "
    greenbg "适用范围：Centos7、Ubuntu、Debian、Raspberry                      "
    greenbg "脚本作者：SITEOJ  QQ群：575440658                                 " 
